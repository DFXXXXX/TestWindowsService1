...
namespace TestWindowsService1
{
    ...
    public class AsyncTCPServer : IDisposable
    {
        ...
        public void Company(object senter,AsyncEventArgs asyncEventArgs) 
        {
           var tcpserver=  senter as AsyncTCPServer;

            var msg = Encoding.UTF8.GetString(asyncEventArgs._state.Buffer).Trim('\0');  
            Console.WriteLine($"服务器:{tcpserver.Address} 接收数据:客户端{asyncEventArgs._state.TcpClient.Client.RemoteEndPoint}数据 {msg}");
        }
        /// <summary>  1
        /// 网络错误事件  
        /// </summary>  
